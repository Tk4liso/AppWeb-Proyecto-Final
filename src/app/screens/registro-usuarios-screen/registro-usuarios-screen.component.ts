...
export class RegistroUsuariosScreenComponent implements OnInit {
  ...
  //ToDo: EditDel - inyección del servicio
  constructor(
  ...
  ngOnInit(): void {
    ...
    //ToDo: EditDel - me daba mucha lata recordar si era maestro o maestros
    if (this.rol === "maestros") {
      this.rol = "maestro";
    }
    //ToDo: EditDel - Por si las dudas también lo hago con alumnos
    if (this.rol === "alumnos") {
      this.rol = "alumno";
    }
